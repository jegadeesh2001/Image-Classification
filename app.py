...
st.header("Please Upload images related to the below topics ")
st.text(class_name)

# create a file uploader and take a image as an jpg or png
file = st.file_uploader("Upload the image you want to predict" , type=["jpg" , "png"])
...
if st.button("Predict"):
    ...
    string = "Image is mostly same as : " + class_name[np.argmax(predictions)]
    st.success(string)